...
const ruta  =  Router();
 ...
 ruta.post("/api/caja_apertura", cajaControlador.abrirCajaTransaccion );
 ...
 ruta.get("/api/metricas_caja/:id_caja/:id_escuela",cajaControlador.listaMetricasCaja);
 ruta.get("/api/metricas_panel/:id_caja/:id_escuela",cajaControlador.metricasPanel);
