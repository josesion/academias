...
const ruta  =  Router();
 ...
 ruta.get("/api/id_caja", validarPermiso ,cajaControlador.idCajaAbierta);
 ruta.get("/api/metricas_caja/:id_caja",  validarPermiso ,cajaControlador.listaMetricasCaja);
 ruta.get("/api/metricas_panel/:id_caja", validarPermiso ,cajaControlador.metricasPanel);
