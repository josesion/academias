...
rutas.put("/api/mod_cuenta/:id_cuenta",permisos.validarPermiso ,cuentasControlador.modCuentaEscuela);
rutas.put("/api/estado_cuenta/:id_cuenta/:estado",permisos.validarPermiso , cuentasControlador.estadoCuentasEscuela);
