...
ruta.put("/api/usu_mod_planes/:id_plan",permisos.validarPermiso,  planesUsuarios.modPlanes_usuarios);
ruta.put("/api/usu_estado_planes/:id_plan/:estado",permisos.validarPermiso,  planesUsuarios.estadoPlanes_usuarios);
