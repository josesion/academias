...
export const MovientoCaja: React.FC<MovimientoCajaProps> = ({
  movimientos,
  infoDetalle,
}) => {
  return (
          ...
          .map((mov) => (
            ...
            >
              ...
              <div className="campo campo_fecha">
                ...
                <span className="valor_texto">{mov.fecha_grupo}</span>
              </div>
              ...
              <div className="campo campo_hora">
                ...
                <span className="valor_texto">{mov.hora_formateada}</span>
              </div>
              ...
              <div className="campo campo_cuenta">
                ...
                <span className="valor_texto">{mov.nombre_cuenta}</span>
              </div>
              ...
              <div className="campo campo_categoria">
                ...
                <span className="valor_texto">{mov.nombre_categoria}</span>
              </div>

              {/* Monto */}
              <div className={`campo campo_monto ${mov.tipo_movimiento}`}>
                <span className="campo_label">Monto</span>
